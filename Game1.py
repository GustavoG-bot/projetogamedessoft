...
class Fundo_intro(pygame.sprite.Sprite):
    def _init_(self,texto1,texto2,texto3,texto4,texto5,texto6,texto7,texto8, cor_da_letra, tamanho_do_titulo,tamanho_da_instrucao, cor_fundo):
...
class Bullet(pygame.sprite.Sprite):
    def _init_(self, assets, posY_personagem, centerx):
        pygame.sprite.Sprite._init_(self)
...
class Fundo_Fim(pygame.sprite.Sprite):
    def _init_(self, texto1, texto2, cor_da_letra, tamanho_do_titulo, cor_fundo):
